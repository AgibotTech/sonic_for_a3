...
//
// Adapted from the MIT-licensed aimrl_sdk::RingBuffer. Copyright belongs to
// the original authors; this file renames the namespace to a3_sync and adds
// the A3-specific header comment.
//
