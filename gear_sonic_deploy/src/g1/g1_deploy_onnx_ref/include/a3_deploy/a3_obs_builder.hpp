...
//
// A3ObsBuilder: assembles the 1570-float `obs_dict` input for the A3 SONIC
...
// order in gear_sonic/envs/manager_env/mdp/observations.py:70+ (not by
...
// Total obs_dict size consumed by monolithic A3 G1-mode ONNX exports.
