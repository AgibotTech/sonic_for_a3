...
// side's `gear_sonic/scripts/generate_a3_order_mapping.py`). A3 is actuated
...
//
// ⚠️ This is NOT the same order as G1's 29-DOF flat layout. G1's "legs →
// waist → arms" grouping happens to coincide with Unitree SDK motor ordering
// and MuJoCo for G1; A3 has no such coincidence. See notes/a3_dof_orderings.md
...
const std::array<int, kA3NeckCount> kG1ToA3NeckIdx = {0, 1};
const std::array<int, kA3NeckCount> kA3NeckToG1Idx = {0, 1};
