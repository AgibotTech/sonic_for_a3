...
def find_a3_asset_dir(script_path: Path, override: str | None) -> Path:
    rels = [
        Path("assets/robot_description/urdf/a3"),
        Path("gear_sonic/data/assets/robot_description/urdf/a3"),
    ]
    candidates = []
    if override:
    ...
    raise FileNotFoundError(
        "could not locate A3 URDF assets; pass --asset-dir "
...
def main() -> int:
    ...
    parser.add_argument("--asset-dir", help="A3 URDF asset directory containing model.urdf and meshes/")
    parser.add_argument(
        "--mesh-url-base",
        help=(
