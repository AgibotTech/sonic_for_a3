...
# These are not permanently bad motions. They are held out for now because the
# current retargeting/eval behavior often makes ground-contact postures fail.
TEMPORARY_RETARGETING_FILTER_KEYWORDS = [
    "kneeling",
    "leaning",
    "crouch",
    "run_loop_180_R",
    "very_fast",
    "avoid_obstacle_right_run_ff",
    "avoid_obstacle_jump_run_ff",
]

# These motions require non-walking support/contact assumptions and are treated
# as formal filters for the current locomotion imitation dataset.
FORMAL_UNLEARNABLE_FILTER_KEYWORDS = [
    "flying",
    "swimming",
]
...
def main():
    ...
    parser.add_argument(
        "--filter-keywords",
        default=DEFAULT_FILTER_KEYWORDS.copy(),
        nargs="+",
