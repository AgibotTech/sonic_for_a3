...
def export_universal_token_module_as_onnx(
    ...
    required_features = set(encoder_tokenizer_obs + decoder_tokenizer_obs)
    required_tokenizer_obs = [
        name for name in module.tokenizer_obs_names if name in required_features
    ]
...
def export_universal_token_encoders_as_onnx(
    ...
    required_tokenizer_obs = [
        obs_name for obs_name in module.tokenizer_obs_names if obs_name in features_needed
    ]
